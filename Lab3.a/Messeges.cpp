...
namespace Lab3_1{
    ...
    void messege_start(Table *&ep) {
        ...
        const char *msgs[] = {"0. Quit",
                              ...
                              "5. Delete element",//удаление элемента из таблицы (с отметкой в поле занятости) по ключу;
                              "6. Clear table and reorganize"// чистка таблицы от “удаленных элементов” – реорганизация таблицы.
                              };
